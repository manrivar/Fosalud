<?php
App::uses('TardiaGeneral', 'Model');

/**
 * TardiaGeneral Test Case
 */
class TardiaGeneralTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TardiaGeneral = ClassRegistry::init('TardiaGeneral');
	}
