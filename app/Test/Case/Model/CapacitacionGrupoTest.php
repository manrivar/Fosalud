<?php
App::uses('CapacitacionGrupo', 'Model');

/**
 * CapacitacionGrupo Test Case
 */
class CapacitacionGrupoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CapacitacionGrupo = ClassRegistry::init('CapacitacionGrupo');
	}
