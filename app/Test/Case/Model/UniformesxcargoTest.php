<?php
App::uses('Uniformesxcargo', 'Model');

/**
 * Uniformesxcargo Test Case
 */
class UniformesxcargoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Uniformesxcargo = ClassRegistry::init('Uniformesxcargo');
	}
