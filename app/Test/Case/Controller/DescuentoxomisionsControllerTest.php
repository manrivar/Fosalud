<?php
App::uses('DescuentoxomisionsController', 'Controller');

/**
 * DescuentoxomisionsController Test Case
 */
class DescuentoxomisionsControllerTest extends ControllerTestCase {
