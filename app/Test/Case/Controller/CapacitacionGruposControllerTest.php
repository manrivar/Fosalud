<?php
App::uses('CapacitacionGruposController', 'Controller');

/**
 * CapacitacionGruposController Test Case
 */
class CapacitacionGruposControllerTest extends ControllerTestCase {
