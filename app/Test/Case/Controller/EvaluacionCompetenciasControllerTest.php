<?php
App::uses('EvaluacionCompetenciasController', 'Controller');

/**
 * EvaluacionCompetenciasController Test Case
 */
class EvaluacionCompetenciasControllerTest extends ControllerTestCase {
