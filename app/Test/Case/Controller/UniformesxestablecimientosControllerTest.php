<?php
App::uses('UniformesxestablecimientosController', 'Controller');

/**
 * UniformesxestablecimientosController Test Case
 */
class UniformesxestablecimientosControllerTest extends ControllerTestCase {
