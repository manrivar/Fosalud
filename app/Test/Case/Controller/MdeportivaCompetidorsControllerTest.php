<?php
App::uses('MdeportivaCompetidorsController', 'Controller');

/**
 * MdeportivaCompetidorsController Test Case
 */
class MdeportivaCompetidorsControllerTest extends ControllerTestCase {
