<?php
App::uses('MarcacionPersonalsController', 'Controller');

/**
 * MarcacionPersonalsController Test Case
 */
class MarcacionPersonalsControllerTest extends ControllerTestCase {
