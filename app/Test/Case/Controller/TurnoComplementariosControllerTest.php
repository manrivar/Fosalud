<?php
App::uses('TurnoComplementariosController', 'Controller');

/**
 * TurnoComplementariosController Test Case
 */
class TurnoComplementariosControllerTest extends ControllerTestCase {
