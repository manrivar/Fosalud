<?php
App::uses('SolicitudConstanciasController', 'Controller');

/**
 * SolicitudConstanciasController Test Case
 */
class SolicitudConstanciasControllerTest extends ControllerTestCase {
