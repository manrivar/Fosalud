<?php
App::uses('DescuentoxincapacidadsController', 'Controller');

/**
 * DescuentoxincapacidadsController Test Case
 */
class DescuentoxincapacidadsControllerTest extends ControllerTestCase {
