<?php
App::uses('EvaluacionResultadosController', 'Controller');

/**
 * EvaluacionResultadosController Test Case
 */
class EvaluacionResultadosControllerTest extends ControllerTestCase {
