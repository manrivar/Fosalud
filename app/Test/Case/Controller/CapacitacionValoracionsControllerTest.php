<?php
App::uses('CapacitacionValoracionsController', 'Controller');

/**
 * CapacitacionValoracionsController Test Case
 */
class CapacitacionValoracionsControllerTest extends ControllerTestCase {
