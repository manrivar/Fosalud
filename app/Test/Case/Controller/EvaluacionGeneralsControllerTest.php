<?php
App::uses('EvaluacionGeneralsController', 'Controller');

/**
 * EvaluacionGeneralsController Test Case
 */
class EvaluacionGeneralsControllerTest extends ControllerTestCase {
