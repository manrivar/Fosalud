<?php
App::uses('EvaluacionObjetivosController', 'Controller');

/**
 * EvaluacionObjetivosController Test Case
 */
class EvaluacionObjetivosControllerTest extends ControllerTestCase {
