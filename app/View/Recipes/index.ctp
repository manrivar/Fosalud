...
<h2>
    <center>Recetas</center>
</h2>
<<<<<<< HEAD
<?php if($this->Session->read('Auth.User.acceso_id') <= 3):?>
<span class="fa fa-upload"></span>
<?php
echo $this->Html->Link('Importar', array('controller' => 'Recipesxestablishments', 'action' => 'cargar_Evaluacion', $yer));
?>
&nbsp;&nbsp;
<?php endif;  ?>
<span class="fa fa-pie-chart"></span> <?php echo $this->Html->Link('Graficos', array('controller' => 'Recipes', 'action' => 'chart', $yer)); ?>
