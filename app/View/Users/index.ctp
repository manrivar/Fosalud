<div class="col-lg-12 col-xs-12 col-sm-12">
    <ol class="breadcrumb">
        <li> 
        <span class="fa fa-undo"></span> <?php echo $this->Html->link(__('Regresar'), array('controller' => 'menus', 'action' => 'admon')); ?>
        </li>
        <li>
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
        <h3><?php echo __('Listado de Usuarios'); ?></h3>
    </div>
        ...
        <table class="table ">
            <thead>
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('regions_id', 'Pertenece a una Region'); ?></th>
            ...
            <tbody>
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td><?php echo h($user['Region']['region_name']); ?>&nbsp;</td>
