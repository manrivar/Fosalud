        ...
        <tbody>
            <?php foreach ($advices as $advice) : ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), array('action' => 'view', $advice['Advice']['id'])); ?>
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $advice['Advice']['id'])); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $advice['Advice']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $advice['Advice']['id']))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('New Advice'), array('action' => 'add')); ?></li>
    </ul>
</div>
<script>
