...
<div class="hcxestablishments form">
    ...
    <fieldset>
        <legend><?php echo __('Edit Rehxestablishment'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Rehxestablishment.id')), array('confirm' => __('Estas seguro que quieres eliminar este registro?', $this->Form->value('Rehxestablishment.id')))); ?></li>
