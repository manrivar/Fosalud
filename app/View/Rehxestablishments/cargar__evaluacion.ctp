<div class="col-lg-12 col-xs-12 col-sm-12">
    <ol class="breadcrumb">
        <li> <span class="fa fa-undo"></span> <?php echo $this->Html->Link('Regresar', array('controller' => 'Rehydrations', 'action' => 'index?yir=' . $yer)); ?></li>
...
<div class="col-lg-12">
    <div class="col-lg-12">
        <center>
            <h3>Carga de Rehidratacion Oral</h3>
        </center>
    </div>
    <div class="col-lg-4">
...
echo $this->Html->script('Rehxestablishment/cargar');
?>