...
<div class="healingsxestablishments form">
    <?php echo $this->Form->create('Healingsxestablishment'); ?>
    <fieldset>
        <legend><?php echo __('Edit Healingsxestablishment'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Healingsxestablishment.id')), array('confirm' => __('Estas seguro que quieres eliminar este registro?', $this->Form->value('Healingsxestablishment.id')))); ?></li>
