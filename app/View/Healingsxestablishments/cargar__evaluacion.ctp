<div class="col-lg-12 col-xs-12 col-sm-12">
    <ol class="breadcrumb">
        <li> <span class="fa fa-undo"></span> <?php echo $this->Html->Link('Regresar', array('controller' => 'Healings', 'action' => 'index?yir=' . $yer)); ?></li>
...
echo $this->Html->script('Healingsxestablishment/cargar');
?>