        ...
        <table class="table table-bordered table-condensed" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th class="text-center" colspan="6">ENERO</th>
                    <th class="text-center" colspan="6">FEBRERO</th>
                    <th class="text-center" colspan="6">MARZO</th>
                    <th class="text-center" colspan="6">ABRIL</th>
                    <th class="text-center" colspan="6">MAYO</th>
                    <th class="text-center" colspan="6">JUNIO</th>
                    <th class="text-center" colspan="6">JULIO</th>
                    <th class="text-center" colspan="6">AGOSTO</th>
                    <th class="text-center" colspan="6">SEPTIEMBRE</th>
                    <th class="text-center" colspan="6">OCTUBRE</th>
                    <th class="text-center" colspan="6">NOVIEMBRE</th>
                    <th class="text-center" colspan="6">DICIEMBRE</th>
                ...
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('niñ_january', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_january', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_january', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_january', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_january', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_february', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_february', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_february', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_february', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_february', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_march', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_march', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_march', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_march', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_march', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_april', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_april', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_april', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_april', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_april', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_may', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_may', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_may', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_may', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_may', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_june', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_june', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_june', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_june', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_june', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_july', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_july', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_july', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_july', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_july', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_august', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_august', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_august', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_august', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_august', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_september', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_september', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_september', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_september', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_september', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_october', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_october', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_october', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_october', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_november', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_november', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_november', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_november', 'Antirrabica'); ?></th>
                    <th><?php echo $this->Paginator->sort('c19_november', 'Covid-19') ?></th>
                    <th><?php echo $this->Paginator->sort('total', 'Total'); ?></th>
                    <th><?php echo $this->Paginator->sort('niñ_december', 'Niños'); ?></th>
                    <th><?php echo $this->Paginator->sort('adu_december', 'Adultos'); ?></th>
                    <th><?php echo $this->Paginator->sort('inf_december', 'Influenza'); ?></th>
                    <th><?php echo $this->Paginator->sort('ant_december', 'Antirrabica'); ?></th>
            ...
            <tbody>
                <?php foreach ($vaccinesxestablishments as $vaccinesxestablishment) : ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $this->Html->link($vaccinesxestablishment['Sibase']['sibase_name'], array('controller' => 'sibases', 'action' => 'view', $vaccinesxestablishment['Sibase']['id'])); ?>
                        </td>
                        <td>
                            <?php echo $this->Html->link($vaccinesxestablishment['Establishment']['establishment_name'], array('controller' => 'establishments', 'action' => 'view', $vaccinesxestablishment['Establishment']['id'])); ?>
                        </td>
                        ...
                        <td><?php echo h($vaccinesxestablishment['Vaccinesxestablishment']['niñ_january'] + $vaccinesxestablishment['Vaccinesxestablishment']['adu_january'] + $vaccinesxestablishment['Vaccinesxestablishment']['inf_january'] + $vaccinesxestablishment['Vaccinesxestablishment']['ant_january'] + $vaccinesxestablishment['Vaccinesxestablishment']['c19_january']); ?></td>
                        ...
                        <td><?php echo h($vaccinesxestablishment['Vaccinesxestablishment']['niñ_march'] + $vaccinesxestablishment['Vaccinesxestablishment']['adu_march'] + $vaccinesxestablishment['Vaccinesxestablishment']['inf_march'] + $vaccinesxestablishment['Vaccinesxestablishment']['ant_march'] + $vaccinesxestablishment['Vaccinesxestablishment']['c19_march']); ?>&nbsp;</td>
                        ...
