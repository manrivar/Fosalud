        ...
        <?php if ($this->Session->read('Auth.User.id')) { ?>
            <div id="header">
                <div class="centrardiv" style="">
                    ...
                    <?php echo $this->Html->image("banner_header.png", array("class" => "banner-noneresponsive img-responsive", "alt" => "Fondo Social para la Salud", 'width' => '100%')); ?>
                    <?php echo $this->Html->image("banner_responsive.png", array("class" => "banner-responsive img-responsive", "alt" => "Fondo Social para la Salud", 'width' => '100%')); ?>
