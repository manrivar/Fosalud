...
<div class="hcxestablishments form">
    <?php echo $this->Form->create('Smokesxestablishment'); ?>
    <fieldset>
        <legend><?php echo __('Edit Smokesxestablishment'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Smokesxestablishment.id')), array('confirm' => __('Estas seguro que quieres eliminar este registro?', $this->Form->value('Smokesxestablishment.id')))); ?></li>
