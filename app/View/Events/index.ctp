...
&nbsp;&nbsp;
<?php endif;  ?>
<span class="fa fa-pie-chart"></span> <?php echo $this->Html->Link('Graficos', array('controller' => 'Events', 'action' => 'chart', $yer)); ?>
    ...
    <table class="table table-bordered table-condensed" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($events as $event) : ?>
                <tr>
                    <td>
                        <?php $region = $event['Region']['id']; ?>
                        <?php echo $this->Html->link($event['Region']['region_name'], array('controller' => 'Eventsxestablishments', 'action' => 'index', $region, $yer)); ?>
                    </td>
                    <?php $total = $event['Event']['trimester1'] + $event['Event']['trimester2'] + $event['Event']['trimester3'] + $event['Event']['trimester4'] ?>
                    <td bgcolor="#CBEEF2"><?php echo $total; ?>&nbsp;</td>
                    <td><?php echo h($event['Event']['trimester1']); ?>&nbsp;</td>
                    <td><?php echo h($event['Event']['trimester2']); ?>&nbsp;</td>
                    <td><?php echo h($event['Event']['trimester3']); ?>&nbsp;</td>
                    <td><?php echo h($event['Event']['trimester4']); ?>&nbsp;</td>
                    <td><?php echo h($event['Event']['year']); ?>&nbsp;</td>
                </tr>
            <?php endforeach; ?>
        </tbody>
        <tfoot>
