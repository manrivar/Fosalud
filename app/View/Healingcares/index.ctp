...
<h2><center>Atencion Curativa</center></h2>
<span class="fa fa-undo"></span> <?php echo $this->Html->Link('Importar', array('controller' => 'Hcxestablishments', 'action' => 'import')); ?>
...
<div class="table-responsive">
  ...
  <table class="table table-bordered table-condensed" cellpadding="0" cellspacing="0">
    ...
    <tbody>
      <?php foreach ($healingcares as $healingcare) : ?>
        <tr>
          <td><?php echo h($healingcare['Healingcare']['id']); ?>&nbsp;</td>
          <td>
            <?php $region = $healingcare['Region']['id']; ?>
            <?php echo $this->Html->link($healingcare['Region']['region_name'], array('controller' => 'Hcxestablishments', 'action' => 'index', $region, $yer)); ?>
          </td>
          <?php $total = $healingcare['Healingcare']['trimester1'] + $healingcare['Healingcare']['trimester2'] + $healingcare['Healingcare']['trimester3'] + $healingcare['Healingcare']['trimester4'] ?>
          <td><?php echo h($healingcare['Healingcare']['trimester1']); ?>&nbsp;</td>
          <td><?php echo h($healingcare['Healingcare']['trimester2']); ?>&nbsp;</td>
          <td><?php echo h($healingcare['Healingcare']['trimester3']); ?>&nbsp;</td>
          <td><?php echo h($healingcare['Healingcare']['trimester4']); ?>&nbsp;</td>
          <td><?php echo $total; ?>&nbsp;</td>
          <td><?php echo h($healingcare['Healingcare']['year']); ?>&nbsp;</td>
          <td class="actions">
            <?php echo $this->Html->link(__('View'), array('action' => 'view', $healingcare['Healingcare']['id'])); ?>
            <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $healingcare['Healingcare']['id'])); ?>
            <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $healingcare['Healingcare']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $healingcare['Healingcare']['id']))); ?>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
