...
<h2><center>Rehidratacion Oral</center></h2>

<?= $this->Form->create('rehydrations', ['type' => 'get']); ?>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-condensed" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($rehydrations as $rehydration) : ?>
                <tr>
                    <td><?php echo h($rehydration['Rehydration']['id']); ?>&nbsp;</td>
                    <td>
                        <?php $region = $rehydration['Region']['id']; ?>
                        <?php echo $this->Html->link($rehydration['Region']['region_name'], array('controller' => 'Rehxestablishments', 'action' => 'index', $region, $yer)); ?>
                    </td>
                    <?php $total = $rehydration['Rehydration']['trimester1'] + $rehydration['Rehydration']['trimester2'] + $rehydration['Rehydration']['trimester3'] + $rehydration['Rehydration']['trimester4'] ?>
                    <td><?php echo h($rehydration['Rehydration']['trimester1']); ?>&nbsp;</td>
                    <td><?php echo h($rehydration['Rehydration']['trimester2']); ?>&nbsp;</td>
                    <td><?php echo h($rehydration['Rehydration']['trimester3']); ?>&nbsp;</td>
                    <td><?php echo h($rehydration['Rehydration']['trimester4']); ?>&nbsp;</td>
                    <td><?php echo $total; ?>&nbsp;</td>
                    <td><?php echo h($rehydration['Rehydration']['year']); ?>&nbsp;</td>
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), array('action' => 'view', $rehydration['Rehydration']['id'])); ?>
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $rehydration['Rehydration']['id'])); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $rehydration['Rehydration']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $rehydration['Rehydration']['id']))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('New Rehydration'), array('action' => 'add')); ?></li>
    </ul>
</div>
<script>
