...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Hcxestablishment.id')), array('confirm' => __('Estas seguro que quieres eliminar este registro?', $this->Form->value('Hcxestablishment.id')))); ?></li>
