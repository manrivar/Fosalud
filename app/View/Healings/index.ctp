...
<h2>
    <center>Curaciones</center>
</h2>
<?php if($this->Session->read('Auth.User.acceso_id') <= 3):?>
<span class="fa fa-upload"></span> <?php echo $this->Html->Link('Importar', array('controller' => 'Healingsxestablishments', 'action' => 'cargar_Evaluacion', $yer)); ?>
&nbsp;&nbsp;
<?php endif;  ?>
<span class="fa fa-pie-chart"></span> <?php echo $this->Html->Link('Graficos', array('controller' => 'Healings', 'action' => 'chart', $yer)); ?>
