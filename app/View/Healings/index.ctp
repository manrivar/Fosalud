...
<?= $this->Form->create('healings', ['type' => 'get']); ?>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-condensed" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($healings as $healing) : ?>
                <tr>
                    <td><?php echo h($healing['Healing']['id']); ?>&nbsp;</td>
                    <td>
                        <?php $region = $healing['Region']['id']; ?>
                        <?php echo $this->Html->link($healing['Region']['region_name'], array('controller' => 'Healingsxestablishments', 'action' => 'index', $region, $yer)); ?>
                    </td>
                    <?php $total = $healing['Healing']['trimester1'] + $healing['Healing']['trimester2'] + $healing['Healing']['trimester3'] + $healing['Healing']['trimester4'] ?>
                    <td><?php echo h($healing['Healing']['trimester1']); ?>&nbsp;</td>
                    <td><?php echo h($healing['Healing']['trimester2']); ?>&nbsp;</td>
                    <td><?php echo h($healing['Healing']['trimester3']); ?>&nbsp;</td>
                    <td><?php echo h($healing['Healing']['trimester4']); ?>&nbsp;</td>
                    <td><?php echo $total; ?>&nbsp;</td>
                    <td><?php echo h($healing['Healing']['year']); ?>&nbsp;</td>
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), array('action' => 'view', $healing['Healing']['id'])); ?>
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $healing['Healing']['id'])); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $healing['Healing']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $healing['Healing']['id']))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('New Healing'), array('action' => 'add')); ?></li>
    </ul>
</div>
<script>
