...
<div class="hcxestablishments form">
    <?php echo $this->Form->create('Vioxestablishment'); ?>
    <fieldset>
        <legend><?php echo __('Edit Vioxestablishment'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Vioxestablishment.id')), array('confirm' => __('Estas seguro que quieres eliminar este registro?', $this->Form->value('Vioxestablishment.id')))); ?></li>
