...
<<<<<<< HEAD
                ...
                $Bitacora["Bitacora"]["descripcion"] = "El usuario ".$this->Session->read('Auth.User.nombre_usuario'). " edito registros de enfermedades cronicas del establecimiento ". $establishments[$id];
...
<<<<<<< HEAD
        $exi = $this->Diseasesxestablishment->find(
            'first',
            array(
                'conditions' => array(
                    'Diseasesxestablishment.regions_id' => $reg,
...
<<<<<<< HEAD
        ...
        $this->loadModel('Bitacora');
        $Bitacora["Bitacora"]["descripcion"] = "El usuario ".$this->Session->read('Auth.User.nombre_usuario'). " Cargo Plantilla de Excel de Enfermedades Cronicas de la ". $exi['Region']['region_name']. " del año ". $year;;
        $Bitacora["Bitacora"]["user_id"] = $this->Session->read('Auth.User.id');
        $this->Bitacora->save($Bitacora);  
